...
import Estella.modules.sql.notes_sql as sql
from Estella import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from Estella.__main__ import DATA_IMPORT
from Estella.modules.helper_funcs.chat_status import user_admin
from Estella.modules.helper_funcs.alternate import typing_action

# from Estella.modules.rules import get_rules
import Estella.modules.sql.rules_sql as rulessql

# from Estella.modules.sql import warns_sql as warnssql
import Estella.modules.sql.blacklist_sql as blacklistsql
from Estella.modules.sql import disable_sql as disabledsql

# from Estella.modules.sql import cust_filters_sql as filtersql
# import Estella.modules.sql.welcome_sql as welcsql
import Estella.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    f = open("Estella{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Estella{}.backup".format(chat_id), "rb"),
